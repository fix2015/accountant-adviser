#!/bin/bash
# Setup script for AI Accountant Adviser GitHub secrets and environment
...
set -e
REPO="fix2015/accountant-adviser"

echo "========================================="
echo "  AI Accountant Adviser - Setup Secrets"
echo "========================================="
echo ""
...
APP_DEBUG=false
APP_ALLOWED_ORIGINS=https://ai-adviser.probooking.app

DATABASE_URL=postgresql://adviser_user:${POSTGRES_PASSWORD}@postgres:5432/adviser_db
...
STRIPE_CONSULTATION_PRICE=1000
...
AWS_S3_PREFIX=ai-adviser

FIRST_ADMIN_EMAIL=admin@ai-adviser.probooking.app
FIRST_ADMIN_PASSWORD=${ADMIN_PASSWORD}
MAX_FREE_QUESTIONS=50"

# ── 4. Create infra .env ──────────────────────────────────────
INFRA_ENV="POSTGRES_USER=adviser_user
POSTGRES_PASSWORD=${POSTGRES_PASSWORD}
POSTGRES_DB=adviser_db
...
gh secret set ADVISER_BACKEND_ENV --repo "$REPO" --body "$BACKEND_ENV_B64"
echo "  ✅ ADVISER_BACKEND_ENV set"

gh secret set ADVISER_INFRA_ENV --repo "$REPO" --body "$INFRA_ENV_B64"
echo "  ✅ ADVISER_INFRA_ENV set"
...
if [ "$EC2_HOST" != "0" ]; then
    ...
    echo "  You need to manually set these in the accountant-adviser repo:"
    echo "    - EC2_HOST"
    echo "    - EC2_USER"
...
echo "    Email: admin@ai-adviser.probooking.app"
