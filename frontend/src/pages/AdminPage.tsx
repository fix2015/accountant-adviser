      ...
      <div className="pt-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center gap-3 mb-8">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-ds-accent-primary to-ds-accent-secondary">
              <Shield className="h-5 w-5 text-white" />
            </div>
            <div>
              <h1 className="text-2xl font-bold text-ds-text-primary">Admin Panel</h1>
              <p className="text-sm text-ds-text-secondary">Manage users, payments, and AI prompts</p>
            </div>
          </div>

          {/* Tabs */}
          <div className="flex gap-1 p-1 rounded-xl bg-ds-bg-secondary border border-ds-border-default mb-8 max-w-max">
            {tabs.map((tab) => (
              <button
                key={tab.id}
