  ...
  return (
    <div className="flex h-full">
      ...
      <button
        ...
        className="hidden lg:flex items-center justify-center w-8 border-l border-ds-border-default bg-ds-bg-secondary hover:bg-ds-bg-tertiary transition-colors"
        title={graphOpen ? "Hide knowledge graph" : "Show knowledge graph"}
      >
        {graphOpen ? (
          <PanelRightClose className="h-4 w-4 text-ds-text-muted" />
        ) : (
          <PanelRightOpen className="h-4 w-4 text-ds-text-muted" />
        )}
      </button>
      ...
      {graphOpen && (
        <div className="hidden lg:flex flex-col w-[35%] min-w-[300px] max-w-[500px] border-l border-ds-border-default bg-ds-bg-secondary">
          <div className="flex items-center gap-2 px-4 py-3 border-b border-ds-border-default">
