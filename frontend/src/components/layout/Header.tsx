...
import { Menu, X, Brain, LogOut, LayoutDashboard, Shield } from "lucide-react";
    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-ds-border-default/50 bg-ds-bg-primary/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden md:flex items-center gap-6">
          {!isAuthenticated ? (
            <>
              <a href="#features" className="text-sm text-ds-text-secondary hover:text-ds-text-primary transition-colors">
                Features
              </a>
              <a href="#pricing" className="text-sm text-ds-text-secondary hover:text-ds-text-primary transition-colors">
                Pricing
              </a>
        ...
        <button
          ...
          className="md:hidden rounded-lg p-2 text-ds-text-muted hover:text-ds-text-primary"
        >
