      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-ds-text-primary">
            Ready to Optimise{" "}
            <span className="text-gradient">Your Taxes?</span>
          </h2>
          <p className="mx-auto mt-6 max-w-xl text-lg text-ds-text-secondary leading-relaxed">
            Join thousands of UK businesses saving money with AI-powered tax
            consultation. Start your consultation today for just £10.
          </p>
